...
import {
  ...
  Phone, ChevronRight, Award, FileCheck, BadgeCheck, CreditCard, Camera,
...
const TRUST_PROMISES = [
  ...
  { icon: BadgeCheck, label: "Customers ID-verified at signup" },
          ...
          <div>
            ...
            <div className="space-y-3 mb-8">
              {[
                ...
                { i: BadgeCheck, t: "Government ID + selfie", d: "Quick ID check, takes 30 seconds" },
      ...
      <div className="max-w-4xl mx-auto px-5 md:px-8 py-12 md:py-16">
        ...
        <div className="space-y-3 mb-10">
          {[
            ...
            { i: BadgeCheck, t: "Branded gear & ID badge", d: "So you know exactly who's at your door" },
        ...
        <div className="space-y-3 mb-10">
          {[
            { i: BadgeCheck, t: "Government ID + selfie verification", d: "Confirmed at signup, before any booking" },
